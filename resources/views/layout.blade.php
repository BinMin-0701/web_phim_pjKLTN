...
<body class="home blog halimthemes halimmovies" data-masonry="">
              ...
              <div class="form-group">
                <div class="input-group col-xs-12">
                  <form action="{{route('tim-kiem')}}" method="GET">
                    ...
                    <!-- <button type="" class="btn btn-primary">Tìm kiếm</button> -->
                  </form>
                </div>
              </div>
              <ul id="result" class="ui-autocomplete ajax-results" style="display: none;"></ul>
            </div>
          </div>
        </div>
      ...
      <div class="row container">
        <div class="widget about col-xs-12 col-sm-4 col-md-4">
          <!-- <div class="footer-logo">
            <img class="img-responsive" src="https://img.favpng.com/9/23/19/movie-logo-png-favpng-nRr1DmYq3SNYSLN8571CHQTEG.jpg" alt="Phim hay 2023- Xem phim hay nhất" />
          </div>
  ...
  <div id="fb-root"></div>
  <script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v17.0" nonce="p3krGHU2"></script>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
            ...
            $.each(data, function(key, value) {
              if (value.title.search(expression) != -1) {
                ...
                $('#result').append('<li style="cursor:pointer; display: flex; max-height: 200px;" class="list-group-item link-class"><img src="uploads/movie/' +
                  value.image + '" width="100" class="" /><div style="flex-direction: column; margin-left: 2px;"><h5 width="100%">' +
                  value.title + '</h5></div></li>')
              }
            });
          });
        } else {
      ...
      $('#result').on('click', 'li', function() {
        var click_text = $(this).text().split('</h5>');

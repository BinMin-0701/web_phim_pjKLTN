...
<body class="cbp-spmenu-push">
  ...
  <div class="main-content">
      ...
      <aside class="sidebar-left">
        <nav class="navbar navbar-inverse">
          <div class="navbar-header">
            ...
            <h1>
              <a class="navbar-brand" href="{{url('/home')}}"><span class="fa fa-area-chart"></span>Phim Free</a>
            </h1>
          </div>
            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview {{($segment=='genre') ? 'active' : ''}}">
                ...
                <ul class="treeview-menu">
                  ...
                  <li>
                    <a href="{{route('genre.index')}}"><i class="fa fa-angle-right"></i>Danh sách Thể loại</a>
                  </li>
                </ul>
              </li>
              ...
              <li class="treeview {{($segment=='linkmovie') ? 'active' : ''}}">
                ...
                <ul class="treeview-menu">
                  ...
                  <li>
                    <a href="{{route('linkmovie.index')}}"><i class="fa fa-angle-right"></i>Danh sách link Phim</a>
                  </li>
                </ul>
              </li>
    ...
    <div id="page-wrapper">
        ...
        <div class="col_3">
          ...
          <div class="col-md-3 widget widget1">
            <div class="r3_counter_box">
              ...
              <div class="stats">
                <h5><a href="{{route('genre.index')}}"><strong>{{$genre_total}}</strong></a></h5>
          ...
          <div class="col-md-3 widget widget1">
            <div class="r3_counter_box">
              ...
              <div class="stats">
                <h5><a href="{{route('country.index')}}"><strong>{{$country_total}}</strong></a></h5>
                <span>Quốc gia</span>
              </div>
            </div>
          </div>
          <div class="col-md-3 widget widget1">
            <div class="r3_counter_box">
              ...
              <div class="stats">
                <h5><a href="{{route('movie.index')}}"><strong>{{$movie_total}}</strong></a></h5>
                <span>Phim</span>
              </div>
            </div>
          </div>
      ...
      <div class="col-md-12 r3_counter_box" style="float: none; margin-top: 2rem;">
        @yield('content')
    ...
    <div class="footer">
      <p>
        &copy;2023 Báo cáo khóa luận tốt nghiệp | Design by BinMin
      </p>
    </div>
    <!--//footer-->
  </div>
  ...
  <!-- Hiển thị tập phim Admin khi chọn phim -->
  <!-- <script>

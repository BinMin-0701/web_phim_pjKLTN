        ...
        <article class="col-md-3 col-sm-3 col-xs-6 thumb grid-item post-37606">
          <div class="halim-item">
            <a class="halim-thumb" href="{{route('movie',$mov->slug)}}">
              <figure><img class="lazy img-responsive" src="{{asset('uploads/movie/'.$mov->image)}}" alt="{{$search}}" title="{{$mov->title}}"></figure>
              <span class="status">
                @if($mov->resolution==0)
                HD
              ...
              <div class="halim-post-title-box">
                <div class="halim-post-title ">
                  ...
                  <p class="original_title">{{$mov->name_eng}}@if ($mov->season!=0)
                    - Season {{$mov->season}}
                    @endif</p>
                </div>
              </div>
